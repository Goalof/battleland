export default {
	...
	"font": {
		"headline1": "normal 500 80px/88px --fontFamily-googleInter",
		"headline2": "normal 400 52px/62px --fontFamily-googleInter",
		"headline3": "normal 500 28px/1.2 --fontFamily-sans",
		"base": "normal 400 16px/24px --fontFamily-googleInter",
		"lead": "normal 400 20px/30px --fontFamily-googleInter"
	},
	"boxShadow": {
